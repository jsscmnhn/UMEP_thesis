...
def define_patch_characteristics(solar_altitude, solar_azimuth,
    ...
    # Define variables
    Ldown_sky = cp.zeros((rows,cols))
    Ldown_veg = cp.zeros((rows,cols))
    Ldown_sun = cp.zeros((rows,cols))
    Ldown_sh = cp.zeros((rows,cols))
    Ldown_ref = cp.zeros((rows,cols))


    Lside_sky = cp.zeros((rows,cols))
    Lside_veg = cp.zeros((rows,cols))
    Lside_sun = cp.zeros((rows,cols))
    Lside_sh = cp.zeros((rows,cols))
    Lside_ref = cp.zeros((rows,cols))

    Least = cp.zeros((rows,cols))
    Lwest = cp.zeros((rows,cols))
    Lnorth = cp.zeros((rows,cols))
    Lsouth = cp.zeros((rows,cols))
