...
def Kside_veg_v2022a(radI,radD,radG,
    ...
    Kref_sun = cp.zeros((rows, cols))
    Kref_sh = cp.zeros((rows, cols))
    Kref_veg = cp.zeros((rows, cols))
    Kside = cp.zeros((rows, cols))

    Kref_veg_n = cp.zeros((rows, cols))
    Kref_veg_s = cp.zeros((rows, cols))
    Kref_veg_e = cp.zeros((rows, cols))
    Kref_veg_w = cp.zeros((rows, cols))

    Kref_sh_n = cp.zeros((rows, cols))
    Kref_sh_s = cp.zeros((rows, cols))
    Kref_sh_e = cp.zeros((rows, cols))
    Kref_sh_w = cp.zeros((rows, cols))

    Kref_sun_n = cp.zeros((rows, cols))
    Kref_sun_s = cp.zeros((rows, cols))
    Kref_sun_e = cp.zeros((rows, cols))
    Kref_sun_w = cp.zeros((rows, cols))

    KeastRef = cp.zeros((rows, cols)); KwestRef = cp.zeros((rows, cols)); KnorthRef = cp.zeros((rows, cols)); KsouthRef = cp.zeros((rows, cols))
    diffRadE = cp.zeros((rows, cols)); diffRadS = cp.zeros((rows, cols)); diffRadW = cp.zeros((rows, cols)); diffRadN = cp.zeros((rows, cols))
