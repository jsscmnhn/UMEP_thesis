...
from functions.SOLWEIGpython.UTIL.shadowingfunction_wallheight_13_cupy import shadowingfunction_wallheight_13_3d
from functions.SOLWEIGpython.UTIL.shadowingfunction_wallheight_23_cupy import shadowingfunction_23_3d
from .gvf_2018a_cupy import gvf_2018a
from .cylindric_wedge_cupy import cylindric_wedge
...
def Solweig_2022a_calc(i, dsms, scale, rows, cols, svf, svfN, svfW, svfE, svfS, svfveg, svfNveg, svfEveg, svfSveg,
    ...
    if altitude > 0: # # # # # # DAYTIME # # # # # #
        ...
        if usevegdem == 1:
            ...
            sh, wallsh, wallsun, facesh, facesun = shadowingfunction_wallheight_13_3d(amaxvalue_dsm, dsms, azimuth, altitude, scale,
