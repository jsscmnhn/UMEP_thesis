...
for i in list:
    ...
    INPUT_SVF = f"{d}:/Geomatics/thesis/_svfcheck/ams/generic/svf153/svfs"
    # INPUT_SVF = f"{d}:Geomatics/thesis/_svfcheck/ams/generic/svf/svfs"
    INPUT_ANISO = f"{d}:/Geomatics/thesis/_svfcheck/ams/generic/svf153/shadowmats.npz"
    ...
    UTC = 0
    OUTPUT_DIR = f"{d}:Geomatics/thesis/_svfcheck/ams/generic/solweig_150"
    INPUT_MET = met_file

    #INPUT_ANISO=INPUT_ANISO
    test = SOLWEIGAlgorithm(INPUT_DSM, INPUT_SVF, INPUT_CDSM, INPUT_HEIGHT, INPUT_ASPECT, UTC, OUTPUT_DIR, INPUT_MET,  INPUT_ANISO=INPUT_ANISO, INPUT_LC=INPUT_LC, INPUT_DTM=INPUT_DTM, INPUT_MULT_DSMS=MULT_DSMS)
